...
import { bool, int } from '../../lib/util.js';
import {
  checkUpdates, currentBuild, importAppRelease, lastCheck, updateSource, updatesState,
...
async function overview() {
  ...
  return {
    current,
    ...updateSource(current), // repo y branch: automáticos, no se configuran
    settings: (await getSettings()).updates,
    last: await lastCheck(),
    ...updatesState(),
  };
}
